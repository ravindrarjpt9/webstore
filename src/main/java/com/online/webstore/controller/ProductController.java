...
public class ProductController {
	...
	public ModelAndView getProductsByFilter(@MatrixVariable(pathVar="ByCriteria") Map<String, List<String>> ByCriteria,ModelAndView modelAndView){
		modelAndView.addObject("products", productService.getProductsByFilter(ByCriteria));
		modelAndView.setViewName("products");
		return modelAndView;
	}
	
	@RequestMapping(value="/product",method=RequestMethod.GET)
	public ModelAndView getProductById(@RequestParam(value="id",required=true) Integer id,ModelAndView modelAndView){
